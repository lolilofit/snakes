...
object SendAnnounsment : Move {
    override fun execute(param: List<Any?>) {
        ...
        val message = SnakesProto.GameMessage.newBuilder().setSenderId(SelfInfo.selfId).setMsgSeq(mesSeq.get())
        ...
        val packet = DatagramPacket(protobufMes, protobufMes.size, SelfInfo.group, SelfInfo.multicastport)
